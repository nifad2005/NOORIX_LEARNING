...
function CourseCard({ course }: any) {
  ...
  return (
    <div
          ...
          >
            <Image
              src={course.courseDatils.image}
              alt={course.courseDatils.title}
              width={400}
              height={200}
              className="w-full h-40 object-cover"
            />
            <div className="p-4">
              <h3 className="text-lg font-bold text-slate-700 mb-2">{course.courseDatils.title}</h3>
              <p className="text-slate-600 mb-4 line-clamp-3">{course.courseDatils.description}</p>
